...
* Then $R(t+h) | I(t) \sim \textrm{Binom}(I(t),\ \gamma h)$.
:::
...
R_0 &= \beta\ /\ \gamma\\
x_{t+1} 
&= \beta \frac{S_{t}}{N} \sum_{k = 0}^t \big[(1-\gamma)^{k}\big] x_{t-k} 
= R_0 \frac{S_{t}}{N} \sum_{k = 0}^t \big[\gamma(1-\gamma)^{k}\big] x_{t-k} 
= R_{t}\sum_{k = 0}^t g(k)x_{t-k}
\end{aligned}$$
...
$$
\mathbb{E}\big[x_{t+1}\ |\ x_1,\ldots,x_{t}\big] = R_t\sum_{a=0}^\infty x_{t-a}\widetilde{g}_a = R_t\times (x * \widetilde{g})_t.
$$
...
* Model $x_{t+1}\ |\ x_1,\ldots,x_{t}$ as Poisson or Negative Binomial
...
$$\begin{aligned}
\eta_t &= \sum_{a=1}^\infty y_{t-a}p_a,\\ \\
...
![](gfx/NSERC_RGB.svg){width=300 fig-align=center}

![](gfx/alliancecan.png){width=500 fig-align=center}
